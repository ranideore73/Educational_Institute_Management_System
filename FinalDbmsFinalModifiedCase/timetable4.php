...
$sql = "INSERT INTO `timetable` (`Day`,`Time`,`Classroom`,`Batch_ID`,`Subject`,`Faculty`)
VALUES('$Day','$Time_slot','$Classroom','$Batch_ID','$Subject','$Faculty')";
...
else
{
	...
	echo "Couldn't update! Please try again.";
}
