...
$sql = "Select `Day`, `Date`, `Time`, `Topic`, `Classroom` FROM `exam` WHERE `Exam_Name` = '$Exam' AND `Course`='$Course'";
$query_run = mysqli_query($conn,$sql);
		if($query_run)
		{
			if(mysqli_num_rows($query_run)==NULL)
			{
				echo "Exam is yet to be Scheduled!<br>";
			}
			else {
			...
			echo "Day : ". $Day."<br>". "Date : ".$Date."<br>". "Time : ".$Time."<br>". "Topic : ".$Topic."<br>". "Classroom : ".$Classroom."<br>";
			}
		}
